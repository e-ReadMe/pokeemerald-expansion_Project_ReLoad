...
enum
{
    ...
    MULTI_DIGIMONEGGCHOICE,
    MULTI_DIGIMONEGGCHOICE_QUIZ_OR_RAND,
    MULTI_DIGIMONEGGCHOICE_QUIZ_START,
    MULTI_DIGIMONEGGCHOICE_VB_OR_NS,
    MULTI_DIGIMONEGGCHOICE_NS_OR_DOE,
    MULTI_DIGIMONEGGCHOICE_ELEMENTAL_START ,
    MULTI_DIGIMONEGGCHOICE_ELEMENTAL_DR_OR_AC,
    MULTI_DIGIMONEGGCHOICE_ELEMENTAL_I_P_W,
    MULTI_DIGIMONEGGCHOICE_ELEMENTAL_DS_OR_BF,
    MULTI_DIGIMONEGGCHOICE_ELEMENTAL_ME_OR_IC,
};
