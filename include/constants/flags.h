...
#define FLAG_UNUSED_0x8E5                           (SYSTEM_FLAGS + 0x85) // ORAS STYLE DOWSING MACHINE
...
#define FLAG_DAILY_MATERIAL_1                       (DAILY_FLAGS_START + 0x15) // Unused Flag - spawns a material in the overworld for upgrading buildings
