...
enum __attribute__((packed)) Item
{
    ...
    ITEM_WHITEGOLD = 145,
    ITEM_MITHRIL = 146,
    ITEM_CHROME_DIGIZOIT = 147,
    ITEM_BLACK_DIGIZOIT = 148,
    //stone
    ITEM_SAND = 149,
    ITEM_STONE = 150,
    ITEM_QUARTZ = 151,
    ...
    #define ITEM_NUGGET ITEM_DEEPWATER
    #define ITEM_BIG_NUGGET ITEM_ACID
    #define ITEM_TINY_MUSHROOM ITEM_OIL
    #define ITEM_TINYMUSHROOM ITEM_OIL
    #define ITEM_BIG_MUSHROOM ITEM_SAP
    #define ITEM_BALM_MUSHROOM ITEM_LATEX
    #define ITEM_BALMMUSHROOM ITEM_LATEX
    #define ITEM_PEARL ITEM_RAINDROP
    #define ITEM_BIG_PEARL ITEM_HOLYWATER
    #define ITEM_PEARL_STRING ITEM_COPPER
    #define ITEM_STARDUST ITEM_SILVER
    #define ITEM_STAR_PIECE ITEM_GOLD
    #define ITEM_COMET_SHARD ITEM_WHITEGOLD
    #define ITEM_SHOAL_SALT ITEM_MITHRIL
    #define ITEM_SHOAL_SHELL ITEM_CHROME_DIGIZOIT
    #define ITEM_RED_SHARD ITEM_BLACK_DIGIZOIT
    #define ITEM_BLUE_SHARD ITEM_SAND
    #define ITEM_YELLOW_SHARD ITEM_STONE
    #define ITEM_GREEN_SHARD ITEM_QUARTZ
    #define ITEM_HEART_SCALE ITEM_ONYX
    #define ITEM_HONEY ITEM_LIGHTSTONE
    #define ITEM_RARE_BONE ITEM_NIGHTSTONE
    #define ITEM_ODD_KEYSTONE ITEM_DIAMOND
    #define ITEM_PRETTY_FEATHER ITEM_WHITEWOOD
    #define ITEM_PRETTY_WING ITEM_WHITEWOOD
    #define ITEM_RELIC_COPPER ITEM_BLACKWOOD
    #define ITEM_RELIC_SILVER ITEM_PALM
    #define ITEM_RELIC_GOLD ITEM_BAMBOO
    #define ITEM_RELIC_VASE ITEM_SNOWWOOD
    #define ITEM_RELIC_BAND ITEM_FIREWOOD
    #define ITEM_RELIC_STATUE ITEM_FELWOOD
    #define ITEM_RELIC_CROWN ITEM_STARWOOD
    #define ITEM_STRANGE_SOUVENIR ITEM_GODWOOD
