...
enum __attribute__((packed)) Ability
{
    ...
    ABILITY_DAMP = 6,
    //ABILITY_LIMBER = 7,
    ABILITY_NUMBING_WAVES = 7,//replaces limber
    ABILITY_SAND_VEIL = 8,
    ABILITY_STATIC = 9,
    ...
    ABILITY_HAYMAKER = 105,// Replaces super luck
    ...
    ABILITY_POISON_THORNS = 143, // Replaces Poison Touch
    ...
    ABILITY_TOUGH_SHELL = 169,//digi ability. replaces fur coat
...
//boost all attacks of X type
    ABILITY_ANCIENT_WARRIOR = 320,
    ABILITY_VIRUS_BUSTER = ABILITY_ANCIENT_WARRIOR + 1,
    ABILITY_ANIMAL_COLOSSEUM = ABILITY_VIRUS_BUSTER + 1,
    ABILITY_VOLCANIC_BEAT = ABILITY_ANIMAL_COLOSSEUM + 1,
    ABILITY_DRAGONS_ROAR = ABILITY_VOLCANIC_BEAT + 1,
    ABILITY_DEEP_SAVERS = ABILITY_DRAGONS_ROAR + 1,
    ABILITY_BLIZZARD_FANG = ABILITY_DEEP_SAVERS + 1,
    ABILITY_IMPULSE_CITY = ABILITY_BLIZZARD_FANG + 1,
    ABILITY_WIND_GUARDIANS = ABILITY_IMPULSE_CITY + 1,
    ABILITY_TITAN_OF_DUST = ABILITY_WIND_GUARDIANS + 1,
    ABILITY_METAL_EMPIRE = ABILITY_TITAN_OF_DUST + 1,
    ABILITY_NIGHT_SOLDIER = ABILITY_METAL_EMPIRE + 1,
    ABILITY_FABLE_WALTZ = ABILITY_NIGHT_SOLDIER + 1,
    ABILITY_NATURE_SPIRIT = ABILITY_FABLE_WALTZ + 1,
    ABILITY_JUNGLE_TROOPERS = ABILITY_NATURE_SPIRIT + 1,
    ABILITY_DYNASTY_OF_EVIL = ABILITY_JUNGLE_TROOPERS + 1,

//new custom abilities
    ABILITY_DEEP_SEA_SLUMBER = ABILITY_DYNASTY_OF_EVIL + 1,//gives all attack an inherant chance to cause sleep on the target. 
    ABILITY_PHOENIX_FEATHER = ABILITY_DEEP_SEA_SLUMBER + 1,//acts like a focus band, with a 66% chance to endure a hit that would otherwise knock the pokemon out.
...
#define ABILITY_SUPER_LUCK ABILITY_HAYMAKER
#define ABILITY_POISON_TOUCH ABILITY_POISON_THORNS
#define ABILITY_FUR_COAT ABILITY_TOUGH_SHELL
#define ABILITY_ICE_SCALES ABILITY_IRON_CLAD
#define ABILITY_LIMBER ABILITY_NUMBING_WAVES
