...
static const struct GMaxMove sGMaxMoveTable[] =
{
    ...
    {SPECIES_MEOWTH_GMAX,                     TYPE_NEUTRAL,     MOVE_G_MAX_GOLD_RUSH},
    ...
    {SPECIES_EEVEE_GMAX,                      TYPE_NEUTRAL,     MOVE_G_MAX_CUDDLE},
    {SPECIES_SNORLAX_GMAX,                    TYPE_NEUTRAL,     MOVE_G_MAX_REPLENISH},
    {SPECIES_GARBODOR_GMAX,                   TYPE_FILTH,     MOVE_G_MAX_MALODOR},
    {SPECIES_MELMETAL_GMAX,                   TYPE_METAL,      MOVE_G_MAX_MELTDOWN},
    ...
    {SPECIES_ORBEETLE_GMAX,                   TYPE_LIGHT,    MOVE_G_MAX_GRAVITAS},
    ...
    {SPECIES_COPPERAJAH_GMAX,                 TYPE_METAL,      MOVE_G_MAX_STEELSURGE},
