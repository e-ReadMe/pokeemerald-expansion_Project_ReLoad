        ...
        else
        {
            ...
            for (j = 0; evolutions[i].params != NULL && evolutions[i].params[j].condition != CONDITIONS_END; j++)
            {
                ...
                case IF_BAG_ITEM_COUNT:
                    ...
                    break;
                case IF_SADNESS:
                    StringAppend(gStringVar4, COMPOUND_STRING("{UP_ARROW_2}sadness"));
                    break;
                case IF_STAT_BASED:
                    StringAppend(gStringVar4, COMPOUND_STRING("reach "));
                    ConvertIntToDecimalStringN(gStringVar2, evolutions[i].params[j].arg2, STR_CONV_MODE_LEFT_ALIGN, 3);
                    StringAppend(gStringVar4, gStringVar2);
                    StringAppend(gStringVar4, COMPOUND_STRING(" "));
                    ...
                    StringAppend(gStringVar4, gStringVar2);
                    StringAppend(gStringVar4, COMPOUND_STRING(", "));
                    ConvertIntToDecimalStringN(gStringVar2, evolutions[i].params[j].arg4, STR_CONV_MODE_LEFT_ALIGN, 3);
                    StringAppend(gStringVar4, gStringVar2);
                    StringAppend(gStringVar4, COMPOUND_STRING(" "));
                    CopyItemName(evolutions[i].params[j].arg3, gStringVar2);
                    StringAppend(gStringVar4, gStringVar2);
                    StringAppend(gStringVar4, COMPOUND_STRING(", "));
                    ConvertIntToDecimalStringN(gStringVar2, evolutions[i].params[j].arg6, STR_CONV_MODE_LEFT_ALIGN, 3);
                    StringAppend(gStringVar4, gStringVar2);
                    StringAppend(gStringVar4, COMPOUND_STRING(" "));
                    CopyItemName(evolutions[i].params[j].arg5, gStringVar2);
                    StringAppend(gStringVar4, gStringVar2);
                    if (evolutions[i].params[j].arg9 != ITEM_NONE)
                        StringAppend(gStringVar4, COMPOUND_STRING("and have "));
                        CopyItemName(evolutions[i].params[j].arg9, gStringVar2);
                        StringAppend(gStringVar4, gStringVar2);
                    break;
                case CONDITIONS_END:
                    break;
