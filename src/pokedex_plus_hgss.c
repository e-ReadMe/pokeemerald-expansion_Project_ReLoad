...
static const struct SearchOptionText sDexSearchTypeOptions[] =
{
    ...
    {gText_DexEmptyString, gTypesInfo[TYPE_METAL].name},
...
{
    enum Type type1, type2, type3;//shows three types on the pokedex;
...
static void CreateTypeIconSprites(void)
{
    ...
    u32 paletteNum = gTypesInfo[TYPE_NEUTRAL].palette + TYPE_INFO_PALETTE_NUM_OFFSET;
