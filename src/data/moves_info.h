...
//-------NEUTRAL-------------------------------------------------------------------------------------------------------------------
    ...
    [MOVE_TAIL_WHIP] =
    {
        .name = COMPOUND_STRING("Tail Whip"),
        .description = COMPOUND_STRING(
            "Strikes with a whip-crack\n"
            "tail. Very likely to flinch."),
        .power = 40,
        .type = TYPE_NORMAL,
        .accuracy = 100,
        .pp = 10,
    ...
    [MOVE_MACH_JAB] =
    {
        .name = COMPOUND_STRING("Mach Jab"),
        .description = COMPOUND_STRING(
            "A jab is thrown at wicked\n"
            "speed to strike first."),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_BEAST,
    ...
    [MOVE_POWER_ENERGY] =
    {
        .name = COMPOUND_STRING("Power Energy"),
        .description = COMPOUND_STRING(
            "A basic blast of energy from\n"
            "the user's digi-core."),
        .effect = EFFECT_HIT,
        .power = 45,
        .type = TYPE_NEUTRAL,
        .accuracy = 100,
    ...
    [MOVE_PHYSICAL_DRAIN] =
    {
        .name = COMPOUND_STRING("Physical Drain"),
        .description = COMPOUND_STRING(
            "Drains the will to fight, to\n"
            "restore health. -1 Foe's ATK."),
        .effect = EFFECT_STRENGTH_SAP,
        .power = 50,
        .type = TYPE_NEUTRAL,
        .accuracy = 100,
    ...
    [MOVE_SPIRAL_EDGE] =
    {
        .name = COMPOUND_STRING("Spiral Edge"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ATTACK_CHARGE] =
    {
        .name = COMPOUND_STRING("Attack Charge"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MENTAL_CHARGE] =
    {
        .name = COMPOUND_STRING("Mental Charge"),
        .description = COMPOUND_STRING(
            "Gathers digi-energy to give\n"
    ...
    [MOVE_MUSCLE_CHARGE] =
    {
        .name = COMPOUND_STRING("Muscle Charge"),
        .description = COMPOUND_STRING(
            "The user is roused.\n"
            "Ups Attack and Sp. Atk."),
        .effect = EFFECT_STAT_CHANGE,
    ...
    [MOVE_GUARD_CHARGE] =
    {
        .name = COMPOUND_STRING("Guard Charge"),
        .description = COMPOUND_STRING(
            "Gathers digi-energy to give\n"
    ...
    [MOVE_MAGIC_CHARGE] =
    {
        .name = COMPOUND_STRING("Magic Charge"),
        .description = COMPOUND_STRING(
            "Gathers digi-energy to give\n"
    ...
    [MOVE_GUARD_FIELD] =
    {
        .name = COMPOUND_STRING("Guard Field"),
        .description = COMPOUND_STRING(
            "Raises the defense on its'\n"
            "side of the field for 5 turns."),
        .effect = EFFECT_REFLECT,
        .power = 0,
        .type = TYPE_NEUTRAL,
        .accuracy = 0,
    ...
    [MOVE_SPEED_CHARGE] =
    {
        .name = COMPOUND_STRING("Speed Charge"),
        .description = COMPOUND_STRING(
            "Gathers digi-energy to give\n"
    ...
    [MOVE_CRITICAL_CHARGE] =
    {
        .name = COMPOUND_STRING("Critical Charge"),
        .description = COMPOUND_STRING(
            "Focuses power to raise the\n"
            "critical-hit ratio."),
        .effect = EFFECT_FOCUS_ENERGY,
    ...
    [MOVE_MASS_MORPH] =
    {
        .name = COMPOUND_STRING("Mass Morph"),
        .description = COMPOUND_STRING(
            "Rearranges the target's data\n"
            "to raise evasiveness."),
        .effect = EFFECT_MINIMIZE,
        .power = 0,
        .type = TYPE_NEUTRAL,
    ...
    [MOVE_GUARD_BREAK] =
    {
        .name = COMPOUND_STRING("Guard Break"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SPEED_BREAK] =
    {
        .name = COMPOUND_STRING("Speed Break"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAGIC_BIND] =
    {
        .name = COMPOUND_STRING("Magic Bind"),
        .description = COMPOUND_STRING(
            "Corrupts the foe's magic"
            "data. -1 Sp. Atk to both foes."),
        .effect = EFFECT_STAT_CHANGE,
        .power = 0,
        .type = TYPE_NEUTRAL,
        .accuracy = 90,
    ...
    [MOVE_MEDITATOR] =
    {
        .name = COMPOUND_STRING("Meditator"),
        .description = COMPOUND_STRING(
            "Heals poisoning, paralysis,\n"
            "or a burn."),
        .effect = EFFECT_REFRESH,
...
//------------------------------------FIRE------------------------------------------------------------
    ...
    [MOVE_GOBLIN_STRIKE] =
    {
        .name = COMPOUND_STRING("Goblin Strike"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HEAT_BREATH] =
    {
        .name = COMPOUND_STRING("Heat Breath"),
        .description = COMPOUND_STRING(
            "Sends a wave of hot air\n"
            "at a single foe. Can Burn."),
        .power = 60,
        .effect = EFFECT_HIT,
        .type = TYPE_FIRE,
        .accuracy = 100,
    ...
    [MOVE_SPIRAL_TWISTER] =
    {
        .name = COMPOUND_STRING("Spiral Twister"),
        .description = COMPOUND_STRING(
            "Traps the foe in a ring of\n"
            "fire for 3-5 turns."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_PANIC_WISP] =
    {
        .name = COMPOUND_STRING("Panic Wisp"),
        .description = COMPOUND_STRING(
            "Uses magical fire to burn the\n"
            "foe."),
        .power = 0,
        .effect = EFFECT_HIT,
        .type = TYPE_FIRE,
...
//-------WATER----------------------------------------------------------------------
    ...
    [MOVE_BUBBLE_BREATH] =
    {
        .name = COMPOUND_STRING("Bubble Breath"),
        .description = COMPOUND_STRING(
            "Spews a blast of frothy\n"
            "bubbles to strike the foe."),
        .power = 50,
        .effect = EFFECT_HIT,
        .type = TYPE_WATER,
        .accuracy = 100,
    ...
    [MOVE_WATER_TOWER] =
    {
        .name = COMPOUND_STRING("Water Tower"),
        .description = COMPOUND_STRING(
            "A geyser of water erupts\n"
            "from underneath the foe."),
        .effect = EFFECT_HIT,
        .power = 50,
        .type = TYPE_WATER,
        .accuracy = 100,
    ...
    [MOVE_BLACK_PEARL_BLAST] =
    {
        .name = COMPOUND_STRING("Black Pearl Blast"),
        .description = COMPOUND_STRING(
            "An exploding pearl causes\n"
            "splash damage. High Crit rate"),
        .effect = EFFECT_HIT,
        .power = 50,
        .type = TYPE_WATER,
        .accuracy = 100,
    ...
    [MOVE_SCISSOR_ATTACK] =
    {
        .name = COMPOUND_STRING("Scissor Attack"),
        .description = COMPOUND_STRING(
            "Slices through the enemy. 2x\n"
            "damage if foe is status'd."),
        .effect = EFFECT_DOUBLE_POWER_ON_ARG_STATUS,
        .argument = { .status = STATUS1_ANY },
        .power = 40,
        .type = TYPE_WATER,
    ...
    [MOVE_LULLABY_BUBBLE] =
    {
        .name = COMPOUND_STRING("Lullaby Bubble"),
        .description = COMPOUND_STRING(
            "Attacks with a song. Chance\n"
    ...
    [MOVE_TIDAL_STREAM] =
    {
        .name = COMPOUND_STRING("Tidal Stream"),
        .description = COMPOUND_STRING(
            "Creates a huge wave, then\n"
            "crashes it down on all foes."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_WATER,
        .accuracy = 90,
    ...
    [MOVE_MARCHING_FISH] =
    {
        .name = COMPOUND_STRING("Marching Fish"),
        .description = COMPOUND_STRING(
            "Some friendly fish come\n"
            "to your aid. Multi-hit."),
        .effect = EFFECT_HIT,
        .power = 20,
        .type = TYPE_WATER,
        .accuracy = 100,
...
//-----------PLANT------------------------------------------
    ...
    [MOVE_VENOM_TRAP] =
    {
        .name = COMPOUND_STRING("Venom Trap"),
        .description = COMPOUND_STRING(
            "Ensnares with itching vines.\n"
            "40% chance to poison."),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_PLANT,
    ...
    [MOVE_THORN_STRIKE] =
    {
        .name = COMPOUND_STRING("Thorn Strike"),
        .description = COMPOUND_STRING(
            "Strikes the foe with\n"
            "slender, whiplike vines."),
            .pp = 25,
    ...
    [MOVE_RAIN_OF_POLLEN] =
    {
        .name = COMPOUND_STRING("Rain of Pollen"),
        .description = COMPOUND_STRING(
            "Spreads allergenic pollen.\n"
            "Lowers Evasiveness."),
        .effect = EFFECT_HIT,
        .power = 50,
        .type = TYPE_PLANT,
    ...
    [MOVE_TROPICAL_BEAK] =
    {
        .name = COMPOUND_STRING("Trop Beak"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ROOT_BIND] =
    {
        .name = COMPOUND_STRING("Root Bind"),
        .description = COMPOUND_STRING(
            "Summons ivy that traps and\n"
            "damages non-plant digimon."),
        .effect = EFFECT_HIT,
        .power = 25,
        .type = TYPE_PLANT,
        .accuracy = 100,
    ...
    [MOVE_BIO_HAZARD] =
    {
        .name = COMPOUND_STRING("Bio Hazard"),
        .description = COMPOUND_STRING(
            "Washes the foes in hazardous\n"
            "biomass. May cause poison."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_PLANT,
        .accuracy = 100,
    ...
    [MOVE_POISON_IVY] =
    {
        ...
        .description = COMPOUND_STRING(
            "Entangles the foe in ivy\n"
            "laced with paralyzing toxins."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_PLANT,
        .accuracy = 100,
    ...
    [MOVE_CRESCENT_LEAF] =
    {
        .name = COMPOUND_STRING("Crescent Leaf"),
        .description = COMPOUND_STRING(
            "Attacks with a strange leaf\n"
            "that cannot be evaded."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_EARTH_COAT] =
    {
        .name = COMPOUND_STRING("Earth Coat"),
        .description = COMPOUND_STRING(
...
//------------------Insect-------------------------
    ...
    [MOVE_ELECTRO_THREAD] =
    {
        .name = COMPOUND_STRING("Electro Thread"),
        .description = COMPOUND_STRING(
            "Spins a thread that's mildly\n"
            "conductive. May paralyse. "),
        .effect = EFFECT_HIT,
        .power = 20,
        .type = TYPE_INSECT,
        .accuracy = 95,
    ...
    [MOVE_INSECT_HORDE] =
    {
        .name = COMPOUND_STRING("Insect Horde"),
        .description = COMPOUND_STRING(
            "Underlings pummel the foe.\n"
            "High critical-hit ratio."),
        .effect = EFFECT_POPULATION_BOMB,
    ...
    [MOVE_CLAW_RUSH] =
    {
        .name = COMPOUND_STRING("Claw Rush"),
        .description = COMPOUND_STRING(
            "Foreleg stingers jab foe\n"
            "repeatedly."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_STICKY_NET] =
    {
        .name = COMPOUND_STRING("Sticky Net"),
        .description = COMPOUND_STRING(
            "Ensnares the foe to stop it\n"
            "from fleeing or switching."),
        .effect = EFFECT_MEAN_LOOK,
...
//------------------BEAST-------------------------
    ...
    [MOVE_COMET_HAMMER] =
    {
        .name = COMPOUND_STRING("Comet Hammer"),
        .description = COMPOUND_STRING(
            "A move that sounds tough,\n"
    ...
    [MOVE_JET_GALLOP] =
    {
        .name = COMPOUND_STRING("Jet Gallop"),
        .description = COMPOUND_STRING(
            "Fires jets to storm down its\n"
            "foe. +1 priority."),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_BEAST
    ...
    [MOVE_SPIN_ATTACK] =
    {
        .name = COMPOUND_STRING("Spin Attack"),
        .description = COMPOUND_STRING(
...
//-------------METAL-----------------------------------------------
    ...
    [MOVE_PLASTIC_BLAZE] =
    {
        .name = COMPOUND_STRING("Plastic Blaze"),
        .description = COMPOUND_STRING(
            "Throws a plastic flame that\n"
            "hurts to step on. Can flinch."),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_PUPPET,
        .accuracy = 100,
    ...
    [MOVE_FATAL_TORNADO] =
    {
        .name = COMPOUND_STRING("Fatal Tornado"),
        .description = COMPOUND_STRING(
            "Breathes out a tornado of\n"
            "draconic flame. May burn."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_DRAGON,
        .accuracy = 100,
    ...
    [MOVE_IRON_SLASH] =
    {
        .name = COMPOUND_STRING("Iron Slash"),
        .description = COMPOUND_STRING(
            "Cuts the foe with cold steel.\n"
    ...
    [MOVE_MECHANICAL_CLAW] =
    {
        .name = COMPOUND_STRING("Mechanical Claw"),
        .description = COMPOUND_STRING(
            "Strikes with claw data taken\n"
            "from a Stage 5. Often +1 Atk"),
        .effect = EFFECT_HIT,
        .power = 50,
        .type = TYPE_STEEL,
        .accuracy = 100,
    ...
    [MOVE_CRUSH_BLADE] =
    {
        .name = COMPOUND_STRING("Crush Blade"),
        .description = COMPOUND_STRING(
            "Spinning blades crush the\n"
            "foe, preventing their escape."),
        .effect = EFFECT_MEAN_LOOK,
        .power = 50,
        .type = TYPE_METAL,
        .accuracy = 90,
    ...
    [MOVE_DIS_ASSEMBLER] =
    {
        .name = COMPOUND_STRING("Dis-Assembler"),
        .description = COMPOUND_STRING(
            "Throws scrap metal using\n"
            "electromagnetism. Can't miss."),
        .effect = EFFECT_HIT,
        .power = 55,
        .type = TYPE_METAL,
        .accuracy = 0,
    ...
    [MOVE_CHRONO_BREAKER] =
    {
        .name = COMPOUND_STRING("Chrono Breaker"),
        .description = COMPOUND_STRING(
            "Stops time flowing through\n"
            "the opponent. Deals 30HP."),
        .effect = EFFECT_FIXED_HP_DAMAGE,
        .power = 1,
...
//-------------------EARTH----------------------
    ...
    [MOVE_SHAMA_HAMMER] =
    {
        .name = COMPOUND_STRING("Shama Hammer"),
        .description = COMPOUND_STRING(
            "Strikes using a ceremonial\n"
            "hammer. Lowers Attack."),
        .effect = EFFECT_HIT,
        .power = 45,
        .type = TYPE_EARTH,
        .accuracy = 85,
    ...
    [MOVE_GAIA_BLAST] =
    {
        .name = COMPOUND_STRING("Gaia Blast"),
        .description = COMPOUND_STRING(
            "Attacks with all the magic\n"
            "of the Earth."),
        .effect = EFFECT_HIT,
        .power = 50,
        .type = TYPE_EARTH,
    ...
    [MOVE_ROCK_FIST] =
    {
        .name = COMPOUND_STRING("Rock Fist"),
        .description = COMPOUND_STRING(
            "Shoots super-hard ore at\n"
            "the foe. May causes flinches."),
        .effect = EFFECT_HIT,
        .power = 50,
        .type = TYPE_EARTH,
        .accuracy = 100,
    ...
    [MOVE_AWESOME_QUAKE] =
    {
        .name = COMPOUND_STRING("Awesome Quake"),
        .description = COMPOUND_STRING(
            "A ground-shaking attack\n"
            "to damage all foes."),
        .effect = EFFECT_HIT,
...
//-------ELECTRIC----------------------------------------------------------------------
    ...
    [MOVE_NANOBOT_BREAK] =
    {
        .name = COMPOUND_STRING("Nanobot Break"),
        .description = COMPOUND_STRING(
            "Summons nanobots to chase\n"
            "the foe. Can't miss."),
        .effect = EFFECT_HIT,
        .power = 45,
        .type = TYPE_ELECTRIC,
    ...
    [MOVE_THUNDER_STRIKE] =
    {
        .name = COMPOUND_STRING("Thunder Strike"),
        .description = COMPOUND_STRING(
            "Blasts the foe with a bolt\n"
    ...
    [MOVE_MEGALO_SPARK] =
    {
        .name = COMPOUND_STRING("Megalo Spark"),
        .description = COMPOUND_STRING(
            "Fires a sphere of electrical\n"
            "energy. May paralyse."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_ELECTRIC,
    ...
    [MOVE_MINI_SCISSOR_CLAW] =
    {
        .name = COMPOUND_STRING("Mini Scissor Claw"),
        .description = COMPOUND_STRING(
            "Cuts with electrified\n"
            "pincers.  High Crit Rate."),
        .effect = EFFECT_HIT,
        .power = 55,
        .type = TYPE_ELECTRIC,
        .accuracy = 100,
    ...
    [MOVE_THUNDER_FALL] =
    {
        .name = COMPOUND_STRING("Thunder Fall"),
        .description = COMPOUND_STRING(
            "Sends electric magic across\n"
            "the field. Hits both targets."),
        .effect = EFFECT_HIT,
        .power = 70,
        .type = TYPE_ELECTRIC,
        .accuracy = 100,
    ...
    [MOVE_HUNTING_CANNON] =
    {
        .name = COMPOUND_STRING("Hunting Cannon"),
        .description = COMPOUND_STRING(
            "Fires energy from its arm\n"
            "cannon. Recharges next turn."),
        .effect = EFFECT_HIT,
        .power = 150,
        .type = TYPE_ELECTRIC,
        .accuracy = 90,
    ...
    [MOVE_ELECTRIC_CLOUD] =
    {
        .name = COMPOUND_STRING("Electric Cloud"),
        .description = COMPOUND_STRING(
            "Gathers static from the air\n"
            "to paralyse the target."),
        .effect = EFFECT_NON_VOLATILE_STATUS,
        .power = 0,
        .type = TYPE_ELECTRIC,
        .accuracy = 100,
...
//-------------WIND-------------------------------------
    ...
    [MOVE_AIR_BUBBLES] =
    {
        .name = COMPOUND_STRING("Air Bubbles"),
        .description = COMPOUND_STRING(
            "Spits some bubbles filled with a\n"
            "tiny gale."),
        .effect = EFFECT_HIT,
        .power = 30,
        .type = TYPE_WIND,
    ...
    [MOVE_SONIC_SHOT] =
    {
        .name = COMPOUND_STRING("Sonic Shot"),
        .description = COMPOUND_STRING(
            "Launches Wind magic to\n"
            "strike the foe. "),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_WIND,
    ...
    [MOVE_WIND_CLAW] =
    {
        .name = COMPOUND_STRING("Wind Claw"),
        .description = COMPOUND_STRING(
            "Strikes the foe with a sharp\n"
            "claw imbued with wind."),
        .effect = EFFECT_HIT,
        .power = 50,
        .type = TYPE_WIND,
        .accuracy = 100,
    ...
    [MOVE_SONIC_JAB] =
    {
        .name = COMPOUND_STRING("Sonic Jab"),
        .description = COMPOUND_STRING(
            "An extremely fast attack\n"
            "that always strikes first."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_AIR_SHOT] =
    {
        .name = COMPOUND_STRING("Air Shot"),
        .description = COMPOUND_STRING(
            "Sucks in air then shoots it\n"
            "in one burst. High crit ratio."),
        .effect = EFFECT_HIT,
        .power = 55,
        .type = TYPE_WIND,
        .accuracy = 95,
    ...
    [MOVE_DARK_TWISTER] =
    {
        .name = COMPOUND_STRING("Dark Twister"),
        .description = COMPOUND_STRING(
            "Whips up a vicious twister\n"
            "to tear at foes. May flinch."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_SPINNING_NEEDLE] =
    {
        .name = COMPOUND_STRING("Spinning Needle"),
            .description = COMPOUND_STRING(
                "Fires twirling needles that\n"
                "shreds all foes."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_WIND,
...
//------------------------ICE-------------------------------------
    ...
    [MOVE_FROZEN_BULLET] =
    {
        .name = COMPOUND_STRING("Frozen Bullet"),
        .description = COMPOUND_STRING(
            "Hurls a chunk of ice that\n"
            "always strikes first."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_DIAMOND_DUST] =
    {
        ...
        .description = COMPOUND_STRING(
            "Strikes several times using\n"
            "a glittering hailstorm."),
        .effect = EFFECT_HIT,
        .power = 20,
        .type = TYPE_ICE,
        .accuracy = 85,
    ...
    [MOVE_SNOW_GOBLI_VOLT] =
    {
        .name = COMPOUND_STRING("Snow Gobli Volt"),
        .description = COMPOUND_STRING(
            "Punches with cold, clammy \n"
            "hands. Gross. May Frostbite."),
        .effect = EFFECT_HIT,
        .power = 45,
        .type = TYPE_ICE,
        .accuracy = 85,
...
//---------------------------DARK MOVES---------------------------
    ...
    [MOVE_SHADOW_FANG] =
    {
        .name = COMPOUND_STRING("Shadow Fang"),
        .description = COMPOUND_STRING(
            "Repeatedly gnaws on the foe.\n"
            "Strikes 2-5 times. "),
        .effect = EFFECT_HIT,
        .power = 15,
        .type = TYPE_DARK,
    ...
    [MOVE_DARK_SPIRIT] =
    {
        .name = COMPOUND_STRING("Dark Spirit"),
        .description = COMPOUND_STRING(
            "Shoots a ball of darkness at \n"
            "the opponent"),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_DARK,
    ...
    [MOVE_HELL_CRUSHER] =
    {
        .name = COMPOUND_STRING("Hell Crusher"),
        .description = COMPOUND_STRING(
            "Attempts to drag the foes'\n"
            "side of the field to hell."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_DARK,
        .accuracy = 90,
    ...
    [MOVE_NAIL_SCRATCH] =
    {
        .name = COMPOUND_STRING("Nail Scratch"),
        .description = COMPOUND_STRING(
            "Scratches the foe with\n"
            "sharp claws."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_COG_CRUSH] =
    {
        .name = COMPOUND_STRING("Cog Crush"),
        .description = COMPOUND_STRING(
            "Nastily crushes the foe\n"
            "between gears. Always hits."),
        .effect = EFFECT_HIT,
        .power = 50,
        .type = TYPE_DARK,
        .accuracy = 0,
    ...
    [MOVE_BLACK_SABER] =
    {
        .name = COMPOUND_STRING("Black Saber"),
        .description = COMPOUND_STRING(
            "Slashes at the foe with dark\n"
            "talons. High Crit rate."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_DARK,
        .accuracy = 100,
    ...
    [MOVE_HUNGRY_HAND] =
    {
        .name = COMPOUND_STRING("Hungry Hand"),
        .description = COMPOUND_STRING(
            "Drains the foe's HP with its\n"
            "claws to restore health."),
        .power = 50,
        .type = TYPE_DARK,
        .accuracy = 100,
        .pp = 10,
    ...
    [MOVE_DEMI_DARTS] =
    {
        .name = COMPOUND_STRING("Demi Darts"),
        .description = COMPOUND_STRING(
            "Launches syringes that hit\n"
            "both foes. Absorbs 75%."),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_DARK,
        .accuracy = 100,
    ...
    [MOVE_BAD_MANNERS] =
    {
        .name = COMPOUND_STRING("Bad Manners"),
        .description = COMPOUND_STRING(
...
//----------------------LIGHT--------------------------------
    ...
    [MOVE_HOLY_LIGHT] =
    {
        ...
        .description = COMPOUND_STRING(
            "Summons a divine light to\n"
            "help its friends. Can't miss."),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_LIGHT,
        .accuracy = 0,
    ...
    [MOVE_BIT_SPEED] =
    {
        .name = COMPOUND_STRING("Bit Speed"),
        .description = COMPOUND_STRING(
            "Speeds forward and strikes\n"
            "with a weapon. +1 Priority."),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_LIGHT,
        .accuracy = 100,
    ...
    [MOVE_PUPPY_HOWL] =
    {
        .name = COMPOUND_STRING("Puppy Howl"),
        .description = COMPOUND_STRING(
            "Attempts to paralyze foes\n"
            "with an ultrasound cry."),
        .effect = EFFECT_HIT,
        .power = 35,
        .type = TYPE_LIGHT,
        .accuracy = 100,
    ...
    [MOVE_SAINT_RAY] =
    {
        .name = COMPOUND_STRING("Saint Ray"),
        .description = COMPOUND_STRING(
            "Attacks with a beam of holy\n"
            "light. "),
        .effect = EFFECT_HIT,
        .power = 50,
        .type = TYPE_LIGHT,
    ...
    {
        .name = COMPOUND_STRING("Heaven's Knuckle"),
        .description = COMPOUND_STRING(
            "A physical holy punch. 10%\n"
            "chance to boost ATK."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_LIGHT,
    ...
    [MOVE_ANGEL_ROD] =
    {
        .name = COMPOUND_STRING("Angel Rod"),
        .description = COMPOUND_STRING(
            "Strikes with a rod bestowed\n"
            "by God. May lower DEF."),
        .effect = EFFECT_HIT,
        .power = 70,
        .type = TYPE_LIGHT,
        .accuracy = 90,
...
//---------------UNDEAD-----------------------------------------
    ...
    [MOVE_ZOMBIE_CLAW] =
    {
        .name = COMPOUND_STRING("Zombie Claw"),
        .description = COMPOUND_STRING(
            "Strikes with a zombie claw.\n"
            "High critical-hit ratio."),
        .effect = EFFECT_HIT,
        .power = 70,
        .type = TYPE_UNDEAD,
...
//---------------FILTH---------------------------------------
    ...
    [MOVE_DANGER_STING] =
    {
        .name = COMPOUND_STRING("Danger Sting"),
        .description = COMPOUND_STRING(
            "Stabs with a small stinger.\n"
            "A quick strike. +1 priority."),
        .effect = EFFECT_HIT,
        .power = 30,
        .type = TYPE_FILTH,
        .accuracy = 100,
    ...
    [MOVE_GLOOM_DUST] =
    {
        .name = COMPOUND_STRING("Gloom Dust"),
        .description = COMPOUND_STRING(
            "Spreads a fog of dark\n"
            "gas at the foe. Can Poison."),
        .effect = EFFECT_HIT,
        .power = 30,
        .type = TYPE_FILTH,
        .accuracy = 100,
    ...
    [MOVE_FUNGUS_CRUSHER] =
    {
        .name = COMPOUND_STRING("Fungus Crusher"),
        .description = COMPOUND_STRING(
            "Throws strange mushrooms. 30\n"
