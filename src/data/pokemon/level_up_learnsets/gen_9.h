...
static const struct LevelUpMove sPunimonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_BUBBLES),
    LEVEL_UP_MOVE(5, MOVE_GUARD_BREAK),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sCaprimonLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_HERTZ_HOWL),
    LEVEL_UP_MOVE( 1, MOVE_GUARD_CHARGE),
    LEVEL_UP_MOVE( 8, MOVE_TAIL_WHIP),
    LEVEL_UP_MOVE(16, MOVE_HEADBUTT),
    LEVEL_UP_MOVE(24, MOVE_ELECTRIC_CLOUD),
    LEVEL_UP_MOVE(32, MOVE_EARTH_COAT),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sPagumonLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_NAIL_SCRATCH),
    LEVEL_UP_MOVE( 3, MOVE_GROWL),
    LEVEL_UP_MOVE(10, MOVE_SAND_ATTACK),
    LEVEL_UP_MOVE(12, MOVE_FURY_SWIPES),
...
static const struct LevelUpMove sPetitmeramonLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_FIRE_BALL),
...
static const struct LevelUpMove sPukamonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(13, MOVE_AIR_BUBBLES),
    LEVEL_UP_END
};

//SPECIES_PYOKOMON
static const struct LevelUpMove sPyokomonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_AIR_BUBBLES),
    LEVEL_UP_MOVE(8, MOVE_SWEET_SCENT),
    LEVEL_UP_MOVE(10, MOVE_THORN_STRIKE),
    LEVEL_UP_END
};

//SPECIES_TANEMON
static const struct LevelUpMove sTanemonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_THORN_STRIKE),
    LEVEL_UP_MOVE(7, MOVE_ADHESIVE_BUBBLE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sTokomonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_BITE),
    LEVEL_UP_MOVE(8, MOVE_AIR_BUBBLES),
...
static const struct LevelUpMove sTsunomonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_STRIKE),
    LEVEL_UP_MOVE(5, MOVE_COMET_HAMMER),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sAgumonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(11, MOVE_STRIKE),
    LEVEL_UP_MOVE(13, MOVE_GROWL),
    LEVEL_UP_MOVE(15, MOVE_ATTACK_CHARGE),
    LEVEL_UP_MOVE(18, MOVE_SCARY_FACE),
    LEVEL_UP_MOVE(20, MOVE_SONIC_JAB),
    LEVEL_UP_END
};

//SPECIES_YUKIAGUMON
static const struct LevelUpMove sYukiagumonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_FROZEN_WIND),
    LEVEL_UP_MOVE(1, MOVE_FROZEN_WIND),
    LEVEL_UP_MOVE(1, MOVE_GUARD_BREAK),
    LEVEL_UP_MOVE(1, MOVE_BUBBLE_BREATH),
    LEVEL_UP_MOVE(1, MOVE_BITE),
    LEVEL_UP_MOVE(11, MOVE_GUARD_BREAK),
    LEVEL_UP_MOVE(12, MOVE_BUBBLE_BREATH),
    LEVEL_UP_MOVE(15, MOVE_BITE),
    LEVEL_UP_MOVE(19, MOVE_HEADBUTT),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sBakumonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_NIGHTMARE_SYNDROME),
    LEVEL_UP_MOVE(1, MOVE_NIGHTMARE_SYNDROME),
    LEVEL_UP_MOVE(1, MOVE_DEFENSE_CURL),
    LEVEL_UP_MOVE(1, MOVE_YAWN),
    LEVEL_UP_MOVE(1, MOVE_GAIA_BLAST),
    LEVEL_UP_MOVE(12, MOVE_YAWN),
    LEVEL_UP_MOVE(14, MOVE_GAIA_BLAST),
    LEVEL_UP_MOVE(17, MOVE_IMPRISON),
    LEVEL_UP_MOVE(19, MOVE_HEAL),
    LEVEL_UP_END
};

//SPECIES_BETAMON
static const struct LevelUpMove sBetamonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_ELECTRO_SHOCK),
    LEVEL_UP_MOVE(1, MOVE_ELECTRO_SHOCK),
    LEVEL_UP_MOVE(1, MOVE_ELECTRIC_CLOUD),
    LEVEL_UP_MOVE(1, MOVE_WATER_TOWER),
    LEVEL_UP_MOVE(1, MOVE_STRIKE),
    LEVEL_UP_MOVE(12, MOVE_ELECTRIC_CLOUD),
    LEVEL_UP_MOVE(15, MOVE_WATER_TOWER),
    LEVEL_UP_MOVE(17, MOVE_STRIKE),
    LEVEL_UP_MOVE(20, MOVE_SPIRAL_EDGE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sModokibetamonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(1, MOVE_WHIRLPOOL),
    LEVEL_UP_MOVE(1, MOVE_ELECTRIC_CLOUD),
    LEVEL_UP_MOVE(1, MOVE_AQUA_MAGIC),
    LEVEL_UP_MOVE(11, MOVE_WHIRLPOOL),
    LEVEL_UP_MOVE(12, MOVE_ELECTRIC_CLOUD),
    LEVEL_UP_MOVE(15, MOVE_AQUA_MAGIC),
    LEVEL_UP_MOVE(20, MOVE_SPIRAL_EDGE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sCandmonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(1, MOVE_CANDLE_SLASH),
    LEVEL_UP_MOVE(1, MOVE_PANIC_WISP),
    LEVEL_UP_MOVE(1, MOVE_DARK_SPIRIT),
    LEVEL_UP_MOVE(11, MOVE_CANDLE_SLASH),
    LEVEL_UP_MOVE(13, MOVE_DARK_SPIRIT),
    LEVEL_UP_MOVE(15, MOVE_PANIC_WISP),
    LEVEL_UP_MOVE(19, MOVE_FIREWALL),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sChuumonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(1, MOVE_CHEESE_BOMB),
    LEVEL_UP_MOVE(1, MOVE_GAIA_BLAST),
    LEVEL_UP_MOVE(1, MOVE_POOP_THROW),
    LEVEL_UP_MOVE(1, MOVE_TRICK),
    LEVEL_UP_MOVE(12, MOVE_POOP_THROW),
    LEVEL_UP_MOVE(15, MOVE_TICKLE),
    LEVEL_UP_MOVE(17, MOVE_GAIA_BLAST),
...
static const struct LevelUpMove sElecmonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_THUNDER_STRIKE),
    LEVEL_UP_MOVE(1, MOVE_THUNDER_STRIKE),
    LEVEL_UP_MOVE(1, MOVE_ELECTRIC_CLOUD),
    LEVEL_UP_MOVE(1, MOVE_LEER),
    LEVEL_UP_MOVE(1, MOVE_FOX_TAIL),
    LEVEL_UP_MOVE(12, MOVE_ELECTRIC_CLOUD),
    LEVEL_UP_MOVE(15, MOVE_LEER),
    LEVEL_UP_MOVE(17, MOVE_FOX_TAIL),
    LEVEL_UP_MOVE(19, MOVE_MUSCLE_CHARGE),
    LEVEL_UP_END
};

//SPECIES_FLORAMON
static const struct LevelUpMove sFloramonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_RAIN_OF_POLLEN),
    LEVEL_UP_MOVE(1, MOVE_RAIN_OF_POLLEN),
    LEVEL_UP_MOVE(1, MOVE_GUARD_BREAK),
    LEVEL_UP_MOVE(1, MOVE_MEDITATOR),
    LEVEL_UP_MOVE(1, MOVE_POISON_POWDER),
    LEVEL_UP_MOVE(11, MOVE_GUARD_BREAK),
    LEVEL_UP_MOVE(13, MOVE_MEDITATOR),
    LEVEL_UP_MOVE(14, MOVE_POISON_POWDER),
    LEVEL_UP_MOVE(15, MOVE_THORN_STRIKE),
    LEVEL_UP_MOVE(18, MOVE_SWEET_SCENT),
    LEVEL_UP_MOVE(20, MOVE_MAGIC_CHARGE),
    LEVEL_UP_END
};

//SPECIES_GABUMON
static const struct LevelUpMove sGabumonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_BLUE_BLASTER),
    LEVEL_UP_MOVE(1, MOVE_BLUE_BLASTER),
    LEVEL_UP_MOVE(1, MOVE_HORN_ATTACK),
    LEVEL_UP_MOVE(1, MOVE_MUSCLE_CHARGE),
    LEVEL_UP_MOVE(1, MOVE_FROZEN_BULLET),
    LEVEL_UP_MOVE(12, MOVE_HORN_ATTACK),
    LEVEL_UP_MOVE(14, MOVE_MUSCLE_CHARGE),
    LEVEL_UP_MOVE(16, MOVE_FROZEN_BULLET),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sPsychemonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(1, MOVE_DARK_SPIRIT),
    LEVEL_UP_MOVE(1, MOVE_MUSCLE_CHARGE),
    LEVEL_UP_MOVE(1, MOVE_MACH_JAB),
    LEVEL_UP_MOVE(12, MOVE_DARK_SPIRIT),
    LEVEL_UP_MOVE(14, MOVE_MUSCLE_CHARGE),
    LEVEL_UP_MOVE(16, MOVE_MACH_JAB),
    LEVEL_UP_MOVE(20, MOVE_MEGATON_PUNCH),
    LEVEL_UP_END
};

//SPECIES_GANIMON
static const struct LevelUpMove sGanimonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_SCISSOR_ATTACK),
    LEVEL_UP_MOVE(1, MOVE_SCISSOR_ATTACK),
    LEVEL_UP_MOVE(1, MOVE_GUARD_CHARGE),
    LEVEL_UP_MOVE(1, MOVE_STRIKE),
    LEVEL_UP_MOVE(1, MOVE_TIDAL_STREAM),
    LEVEL_UP_MOVE(10, MOVE_GUARD_CHARGE),
    LEVEL_UP_MOVE(12, MOVE_STRIKE),
    LEVEL_UP_MOVE(16, MOVE_TIDAL_STREAM),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sGazimonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(1, MOVE_THUNDER_STRIKE),
    LEVEL_UP_MOVE(1, MOVE_DARK_SPIRIT),
    LEVEL_UP_MOVE(1, MOVE_SPEED_CHARGE),
    LEVEL_UP_MOVE(1, MOVE_WIND_CLAW),
    LEVEL_UP_MOVE(10, MOVE_DARK_SPIRIT),
    LEVEL_UP_MOVE(12, MOVE_SPEED_CHARGE),
    LEVEL_UP_MOVE(15, MOVE_WIND_CLAW),
    LEVEL_UP_MOVE(19, MOVE_PANIC_WISP),
    LEVEL_UP_END
};

//SPECIES_GIZAMON
static const struct LevelUpMove sGizamonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_WATER_TOWER),
    LEVEL_UP_MOVE(1, MOVE_WATER_TOWER),
    LEVEL_UP_MOVE(1, MOVE_ATTACK_CHARGE),
    LEVEL_UP_MOVE(1, MOVE_SPIRAL_EDGE),
    LEVEL_UP_MOVE(5, MOVE_ATTACK_CHARGE),
    LEVEL_UP_MOVE(15, MOVE_SPIRAL_EDGE),
    LEVEL_UP_END
};

//SPECIES_GOBLIMON
static const struct LevelUpMove sGoblimonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_GOBLIN_STRIKE),
    LEVEL_UP_MOVE(1, MOVE_GOBLIN_STRIKE),
    LEVEL_UP_MOVE(1, MOVE_CRITICAL_CHARGE),
    LEVEL_UP_MOVE(1, MOVE_COMET_HAMMER),
    LEVEL_UP_MOVE(1, MOVE_POISON_POWDER),
    LEVEL_UP_MOVE(10, MOVE_CRITICAL_CHARGE),
    LEVEL_UP_MOVE(12, MOVE_COMET_HAMMER),
    LEVEL_UP_MOVE(14, MOVE_POISON_POWDER),
    LEVEL_UP_MOVE(18, MOVE_MACH_JAB),
    LEVEL_UP_MOVE(20, MOVE_MUSCLE_CHARGE),
    LEVEL_UP_END
};

//SPECIES_SHAMAMON
static const struct LevelUpMove sShamamonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_SHAMA_HAMMER),
    LEVEL_UP_MOVE(1, MOVE_SHAMA_HAMMER),
    LEVEL_UP_MOVE(1, MOVE_GUARD_BREAK),
    LEVEL_UP_MOVE(1, MOVE_BLACKOUT),
    LEVEL_UP_MOVE(1, MOVE_HELL_CRUSHER),
    LEVEL_UP_MOVE(10, MOVE_GUARD_BREAK),
    LEVEL_UP_MOVE(12, MOVE_BLACKOUT),
    LEVEL_UP_MOVE(14, MOVE_HELL_CRUSHER),
    LEVEL_UP_MOVE(18, MOVE_MACH_JAB),
    LEVEL_UP_MOVE(20, MOVE_MUSCLE_CHARGE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sSnowgoblimonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_SNOW_GOBLI_VOLT),
    LEVEL_UP_MOVE(1, MOVE_SNOW_GOBLI_VOLT),
    LEVEL_UP_MOVE(1, MOVE_SPEED_BREAK),
    LEVEL_UP_MOVE(1, MOVE_BUBBLE_BREATH),
    LEVEL_UP_MOVE(1, MOVE_DIAMOND_DUST),
    LEVEL_UP_MOVE(10, MOVE_SPEED_BREAK),
    LEVEL_UP_MOVE(12, MOVE_BUBBLE_BREATH),
    LEVEL_UP_MOVE(14, MOVE_DIAMOND_DUST),
    LEVEL_UP_MOVE(18, MOVE_MACH_JAB),
    LEVEL_UP_MOVE(20, MOVE_MUSCLE_CHARGE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sGomamonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_MARCHING_FISH),
    LEVEL_UP_MOVE(1, MOVE_MARCHING_FISH),
    LEVEL_UP_MOVE(1, MOVE_GUARD_FIELD),
    LEVEL_UP_MOVE(1, MOVE_DIAMOND_DUST),
    LEVEL_UP_MOVE(1, MOVE_IDLE_BUBBLE),
    LEVEL_UP_MOVE(11, MOVE_GUARD_FIELD),
    LEVEL_UP_MOVE(12, MOVE_DIAMOND_DUST),
    LEVEL_UP_MOVE(14, MOVE_IDLE_BUBBLE),
    LEVEL_UP_MOVE(18, MOVE_BUBBLE_BREATH),
    LEVEL_UP_MOVE(20, MOVE_MUSCLE_CHARGE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sGotsumonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_ROCK_FIST),
    LEVEL_UP_MOVE(1, MOVE_ROCK_FIST),
    LEVEL_UP_MOVE(1, MOVE_GUARD_CHARGE),
    LEVEL_UP_MOVE(1, MOVE_GAIA_BLAST),
    LEVEL_UP_MOVE(1, MOVE_ROOT_BIND),
    LEVEL_UP_MOVE(10, MOVE_GUARD_CHARGE),
    LEVEL_UP_MOVE(13, MOVE_GAIA_BLAST),
    LEVEL_UP_MOVE(16, MOVE_ROOT_BIND),
    LEVEL_UP_MOVE(18, MOVE_SPIN_ATTACK),
    LEVEL_UP_MOVE(20, MOVE_BIO_HAZARD),
    LEVEL_UP_END
};

//SPECIES_HAGURUMON
static const struct LevelUpMove sHagurumonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_COG_CRUSH),
    LEVEL_UP_MOVE(1, MOVE_COG_CRUSH),
    LEVEL_UP_MOVE(1, MOVE_NANOBOT_BREAK),
    LEVEL_UP_MOVE(1, MOVE_IRON_SLASH),
    LEVEL_UP_MOVE(1, MOVE_FIREWALL),
    LEVEL_UP_MOVE(10, MOVE_NANOBOT_BREAK),
    LEVEL_UP_MOVE(14, MOVE_IRON_SLASH),
    LEVEL_UP_MOVE(17, MOVE_FIREWALL),
    LEVEL_UP_END
};

//SPECIES_KOKUWAMON
static const struct LevelUpMove sKokuwamonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_MINI_SCISSOR_CLAW),
    LEVEL_UP_MOVE(1, MOVE_MINI_SCISSOR_CLAW),
    LEVEL_UP_MOVE(1, MOVE_CRITICAL_CHARGE),
    LEVEL_UP_MOVE(1, MOVE_NANOBOT_BREAK),
    LEVEL_UP_MOVE(1, MOVE_DIS_ASSEMBLER),
    LEVEL_UP_MOVE(12, MOVE_CRITICAL_CHARGE),
    LEVEL_UP_MOVE(15, MOVE_NANOBOT_BREAK),
    LEVEL_UP_MOVE(18, MOVE_DIS_ASSEMBLER),
    LEVEL_UP_END
};

//SPECIES_KUNEMON
static const struct LevelUpMove sKunemonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_ELECTRO_THREAD),
    LEVEL_UP_MOVE(1, MOVE_ELECTRO_THREAD),
    LEVEL_UP_MOVE(1, MOVE_DANGER_STING),
    LEVEL_UP_MOVE(1, MOVE_ELECTRIC_CLOUD),
    LEVEL_UP_MOVE(1, MOVE_POISON_CLAW),
    LEVEL_UP_MOVE(11, MOVE_DANGER_STING),
    LEVEL_UP_MOVE(13, MOVE_MASS_MORPH),
    LEVEL_UP_MOVE(15, MOVE_ELECTRIC_CLOUD),
    LEVEL_UP_MOVE(17, MOVE_POISON_CLAW),
    LEVEL_UP_MOVE(20, MOVE_ELECTRO_SHOCK),
    LEVEL_UP_END
};

//SPECIES_DOKUNEMON
static const struct LevelUpMove sDokunemonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_INSECT_HORDE),
    LEVEL_UP_MOVE(1, MOVE_INSECT_HORDE),
    LEVEL_UP_MOVE(1, MOVE_STICKY_NET),
    LEVEL_UP_MOVE(1, MOVE_ELECTRIC_CLOUD),
    LEVEL_UP_MOVE(1, MOVE_POISON_POWDER),
    LEVEL_UP_MOVE(10, MOVE_STICKY_NET),
    LEVEL_UP_MOVE(12, MOVE_ELECTRIC_CLOUD),
    LEVEL_UP_MOVE(13, MOVE_MASS_MORPH),
    LEVEL_UP_MOVE(14, MOVE_POISON_POWDER),
    LEVEL_UP_MOVE(18, MOVE_ELECTRO_SHOCK),
    LEVEL_UP_END
};

//SPECIES_MUSHMON
static const struct LevelUpMove sMushmonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_FUNGUS_CRUSHER),
    LEVEL_UP_MOVE(1, MOVE_FUNGUS_CRUSHER),
    LEVEL_UP_MOVE(1, MOVE_VENOM_TRAP),
    LEVEL_UP_MOVE(1, MOVE_CRESCENT_LEAF),
    //LEVEL_UP_MOVE(1, MOVE_TEXTURE_BLOW),
    LEVEL_UP_MOVE(12, MOVE_VENOM_TRAP),
    LEVEL_UP_MOVE(16, MOVE_CRESCENT_LEAF),
    //LEVEL_UP_MOVE(20, MOVE_TEXTURE_BLOW),
    LEVEL_UP_END
};

//SPECIES_OTAMAMON
static const struct LevelUpMove sOtamamonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_LULLABY_BUBBLE),
    LEVEL_UP_MOVE(1, MOVE_LULLABY_BUBBLE),
    LEVEL_UP_MOVE(1, MOVE_IDLE_BUBBLE),
    LEVEL_UP_MOVE(1, MOVE_WATER_TOWER),
    LEVEL_UP_MOVE(1, MOVE_TIDAL_STREAM),
    LEVEL_UP_MOVE(15, MOVE_IDLE_BUBBLE),
    LEVEL_UP_MOVE(18, MOVE_WATER_TOWER),
    LEVEL_UP_MOVE(20, MOVE_TIDAL_STREAM),
    LEVEL_UP_END
};

//SPECIES_PALMON
static const struct LevelUpMove sPalmonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_POISON_IVY),
    LEVEL_UP_MOVE(1, MOVE_POISON_IVY),
    LEVEL_UP_MOVE(1, MOVE_CRESCENT_LEAF),
    LEVEL_UP_MOVE(1, MOVE_VENOM_TRAP),
    LEVEL_UP_MOVE(1, MOVE_MASS_MORPH),
    LEVEL_UP_MOVE(12, MOVE_CRESCENT_LEAF),
    LEVEL_UP_MOVE(14, MOVE_VENOM_TRAP),
    LEVEL_UP_MOVE(15, MOVE_POISON_POWDER),
    LEVEL_UP_MOVE(15, MOVE_MASS_MORPH),
    LEVEL_UP_MOVE(17, MOVE_HEAL),
    LEVEL_UP_MOVE(20, MOVE_IDLE_BUBBLE),
    LEVEL_UP_END
};

//SPECIES_ALRAUMON
static const struct LevelUpMove sAlraumonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_GLOOM_DUST),
    LEVEL_UP_MOVE(1, MOVE_GLOOM_DUST),
    LEVEL_UP_MOVE(1, MOVE_CRESCENT_LEAF),
    LEVEL_UP_MOVE(1, MOVE_VENOM_TRAP),
    LEVEL_UP_MOVE(1, MOVE_HEAL),
    LEVEL_UP_MOVE(10, MOVE_CRESCENT_LEAF),
    LEVEL_UP_MOVE(12, MOVE_VENOM_TRAP),
    LEVEL_UP_MOVE(15, MOVE_HEAL),
    LEVEL_UP_MOVE(17, MOVE_POISON_CLAW),
    LEVEL_UP_MOVE(20, MOVE_HUNGRY_HAND),
    LEVEL_UP_END
};

//SPECIES_PATAMON
static const struct LevelUpMove sPatamonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_AIR_SHOT),
    LEVEL_UP_MOVE(1, MOVE_AIR_SHOT),
    LEVEL_UP_MOVE(1, MOVE_MENTAL_CHARGE),
    LEVEL_UP_MOVE(1, MOVE_HOLY_LIGHT),
    LEVEL_UP_MOVE(1, MOVE_MEDITATOR),
    LEVEL_UP_MOVE(10, MOVE_MENTAL_CHARGE),
    LEVEL_UP_MOVE(12, MOVE_HOLY_LIGHT),
    LEVEL_UP_MOVE(14, MOVE_MEDITATOR),
    LEVEL_UP_MOVE(15, MOVE_SPEED_CHARGE),
    LEVEL_UP_MOVE(17, MOVE_SPIN_ATTACK),
    LEVEL_UP_MOVE(20, MOVE_SONIC_JAB),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sTsukaimonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_DARK_TWISTER),
    LEVEL_UP_MOVE(1, MOVE_DARK_TWISTER),
    LEVEL_UP_MOVE(1, MOVE_BAD_MANNERS),
    LEVEL_UP_MOVE(1, MOVE_BLACKOUT),
    LEVEL_UP_MOVE(1, MOVE_GLOOM_DUST),
...
//SPECIES_PENMON
static const struct LevelUpMove sPenmonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_SUPER_SLAP),
    LEVEL_UP_MOVE(1, MOVE_SUPER_SLAP),
    LEVEL_UP_MOVE(1, MOVE_CRITICAL_CHARGE),
    LEVEL_UP_MOVE(1, MOVE_FROZEN_WIND),
    LEVEL_UP_MOVE(1, MOVE_WIND_CLAW),
    LEVEL_UP_MOVE(10, MOVE_CRITICAL_CHARGE),
    LEVEL_UP_MOVE(13, MOVE_FROZEN_WIND),
    LEVEL_UP_MOVE(17, MOVE_WIND_CLAW),
    LEVEL_UP_MOVE(19, MOVE_SNOWSCAPE),
    LEVEL_UP_MOVE(20, MOVE_ICY_GLIDE),
    LEVEL_UP_END
};

//SPECIES_MUCHOMON
static const struct LevelUpMove sMuchomonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_TROPICAL_BEAK),
    LEVEL_UP_MOVE(1, MOVE_SUPER_SLAP),
    LEVEL_UP_MOVE(1, MOVE_TROPICAL_BEAK),
    LEVEL_UP_MOVE(1, MOVE_SPITFIRE),
    LEVEL_UP_MOVE(1, MOVE_MENTAL_CHARGE),
    LEVEL_UP_MOVE(11, MOVE_SUPER_SLAP),
    LEVEL_UP_MOVE(14, MOVE_TROPICAL_BEAK),
    LEVEL_UP_MOVE(16, MOVE_SPITFIRE),
    LEVEL_UP_MOVE(17, MOVE_MENTAL_CHARGE),
    LEVEL_UP_MOVE(19, MOVE_SUNNY_DAY),
    LEVEL_UP_MOVE(20, MOVE_WIND_CLAW),
    LEVEL_UP_END
};

//SPECIES_PICODEVIMON
static const struct LevelUpMove sPicodevimonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_DEMI_DARTS),
    LEVEL_UP_MOVE(1, MOVE_DEMI_DARTS),
    LEVEL_UP_MOVE(1, MOVE_RAGE),
    LEVEL_UP_MOVE(1, MOVE_BAD_MANNERS),
    LEVEL_UP_MOVE(1, MOVE_SHADOW_FANG),
    LEVEL_UP_MOVE(10, MOVE_RAGE),
    LEVEL_UP_MOVE(11, MOVE_PANIC_WISP),
    LEVEL_UP_MOVE(13, MOVE_BAD_MANNERS),
    LEVEL_UP_MOVE(15, MOVE_SHADOW_FANG),
    LEVEL_UP_MOVE(17, MOVE_WING_SHOES),
    LEVEL_UP_MOVE(19, MOVE_WIND_CUTTER),
    LEVEL_UP_MOVE(20, MOVE_HAIL_SPEAR),
    LEVEL_UP_END
};

//SPECIES_PIYOMON
static const struct LevelUpMove sPiyomonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_SPIRAL_TWISTER),
    LEVEL_UP_MOVE(1, MOVE_SPIRAL_TWISTER),
    LEVEL_UP_MOVE(1, MOVE_SONIC_SHOT),
    LEVEL_UP_MOVE(1, MOVE_HEAL),
    LEVEL_UP_MOVE(1, MOVE_WING_SHOES),
    LEVEL_UP_MOVE(10, MOVE_SONIC_SHOT),
    LEVEL_UP_MOVE(13, MOVE_HEAL),
    LEVEL_UP_MOVE(16, MOVE_WIND_CUTTER),
    LEVEL_UP_MOVE(18, MOVE_WING_SHOES),
    LEVEL_UP_MOVE(20, MOVE_FIREWALL),
    LEVEL_UP_END
};

//SPECIES_PLOTMON
static const struct LevelUpMove sPlotmonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_PUPPY_HOWL),
    LEVEL_UP_MOVE(1, MOVE_PUPPY_HOWL),
    LEVEL_UP_MOVE(1, MOVE_LIGHT_SOUL),
    LEVEL_UP_MOVE(1, MOVE_HEAL),
    LEVEL_UP_MOVE(1, MOVE_EARTH_COAT),
    LEVEL_UP_MOVE(11, MOVE_LIGHT_SOUL),
    LEVEL_UP_MOVE(13, MOVE_HEAL),
    LEVEL_UP_MOVE(15, MOVE_EARTH_COAT),
    LEVEL_UP_MOVE(17, MOVE_FLASH),
    LEVEL_UP_MOVE(19, MOVE_MACH_JAB),
    LEVEL_UP_MOVE(20, MOVE_MUSCLE_CHARGE),
    LEVEL_UP_END
};

//SPECIES_SHAKOMON
static const struct LevelUpMove sShakomonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_BLACK_PEARL_BLAST),
    LEVEL_UP_MOVE(1, MOVE_BLACK_PEARL_BLAST),
    LEVEL_UP_MOVE(1, MOVE_CRITICAL_CHARGE),
    LEVEL_UP_MOVE(1, MOVE_MAGIC_CHARGE),
    LEVEL_UP_MOVE(1, MOVE_TIDAL_STREAM),
    LEVEL_UP_MOVE(11, MOVE_CRITICAL_CHARGE),
    LEVEL_UP_MOVE(13, MOVE_MAGIC_CHARGE),
    LEVEL_UP_MOVE(16, MOVE_TIDAL_STREAM),
    LEVEL_UP_MOVE(17, MOVE_HAIL_SPEAR),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sTentomonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_ELECTRO_SHOCK),
    LEVEL_UP_MOVE(1, MOVE_NANOBOT_BREAK),
    LEVEL_UP_MOVE(1, MOVE_CLAW_RUSH),
    LEVEL_UP_MOVE(1, MOVE_MUSCLE_CHARGE),
    LEVEL_UP_MOVE(1, MOVE_SPIN_ATTACK),
    LEVEL_UP_MOVE(10, MOVE_NANOBOT_BREAK),
    LEVEL_UP_MOVE(12, MOVE_MUSCLE_CHARGE),
    LEVEL_UP_MOVE(13, MOVE_CLAW_RUSH),
    LEVEL_UP_MOVE(14, MOVE_SPIN_ATTACK),
    LEVEL_UP_MOVE(16, MOVE_ELECTRIC_CLOUD),
    LEVEL_UP_MOVE(17, MOVE_MASS_MORPH),
    LEVEL_UP_MOVE(20, MOVE_THORN_STRIKE),
    LEVEL_UP_END
};

//SPECIES_TOYAGUMON
static const struct LevelUpMove sToyagumonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_PLASTIC_BLAZE),
    LEVEL_UP_MOVE(1, MOVE_PLASTIC_BLAZE),
    LEVEL_UP_MOVE(1, MOVE_NANOBOT_BREAK),
    LEVEL_UP_MOVE(1, MOVE_ELECTRIC_CLOUD),
    LEVEL_UP_MOVE(1, MOVE_FIRE_BALL),
    LEVEL_UP_MOVE(10, MOVE_POWER_ENERGY),
    LEVEL_UP_MOVE(11, MOVE_UPGRADE),
    LEVEL_UP_MOVE(12, MOVE_NANOBOT_BREAK),
    LEVEL_UP_MOVE(13, MOVE_ELECTRIC_CLOUD),
    LEVEL_UP_MOVE(17, MOVE_FIRE_BALL),
    LEVEL_UP_MOVE(18, MOVE_MECHANICAL_CLAW),
    LEVEL_UP_MOVE(20, MOVE_FIREWALL),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sClearagumonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(11, MOVE_MACH_JAB),
    LEVEL_UP_MOVE(12, MOVE_MUSCLE_CHARGE),
    LEVEL_UP_MOVE(15, MOVE_MECHANICAL_CLAW),
    LEVEL_UP_MOVE(16, MOVE_UPGRADE),
    LEVEL_UP_MOVE(18, MOVE_NANOBOT_BREAK),
    LEVEL_UP_MOVE(19, MOVE_ELECTRIC_CLOUD),
    LEVEL_UP_MOVE(20, MOVE_FIREWALL),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sAirdramonLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_SONIC_SHOT),
    LEVEL_UP_MOVE( 1, MOVE_SPEED_CHARGE),
    LEVEL_UP_MOVE( 1, MOVE_BITE),
    LEVEL_UP_MOVE( 1, MOVE_GUARD_BREAK),
    LEVEL_UP_MOVE( 8, MOVE_SONIC_SHOT),
    LEVEL_UP_MOVE(11, MOVE_SPEED_CHARGE),
    LEVEL_UP_MOVE(18, MOVE_WIND_CLAW),
    LEVEL_UP_MOVE(21, MOVE_SPINNING_NEEDLE),
    LEVEL_UP_MOVE(28, MOVE_FATAL_TORNADO),
    LEVEL_UP_MOVE(31, MOVE_TAIL_WHIP),
    LEVEL_UP_MOVE(35, MOVE_MEGALO_SPARK),
    LEVEL_UP_MOVE(40, MOVE_DRAGON_DANCE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sAngemonLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_HOLY_LIGHT),
    LEVEL_UP_MOVE( 1, MOVE_FLASH),
    LEVEL_UP_MOVE( 1, MOVE_HEAL),
    LEVEL_UP_MOVE( 1, MOVE_SAINT_RAY),
    LEVEL_UP_MOVE(10, MOVE_HEAL),
    LEVEL_UP_MOVE(18, MOVE_SAINT_RAY),
    LEVEL_UP_MOVE(25, MOVE_BIT_SPEED),
    LEVEL_UP_MOVE(33, MOVE_ATTACK_CHARGE),
    LEVEL_UP_MOVE(40, MOVE_MAGIC_CHARGE),
    LEVEL_UP_MOVE(49, MOVE_ANGEL_ROD),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sPidmonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_FLASH),
    LEVEL_UP_MOVE( 1, MOVE_HEAL),
    LEVEL_UP_MOVE( 1, MOVE_HEAT_BREATH),
    LEVEL_UP_MOVE(10, MOVE_HEAL),
    LEVEL_UP_MOVE(18, MOVE_SAINT_RAY),
    LEVEL_UP_MOVE(25, MOVE_HEAVENS_KNUCKLE),
    LEVEL_UP_MOVE(33, MOVE_ATTACK_CHARGE),
    LEVEL_UP_MOVE(40, MOVE_MAGIC_CHARGE),
    LEVEL_UP_MOVE(49, MOVE_ANGEL_ROD),
    LEVEL_UP_END
...
static const struct LevelUpMove sBakemonLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_KNOCK_OFF),
    LEVEL_UP_MOVE( 1, MOVE_SCREECH),
    LEVEL_UP_MOVE( 1, MOVE_ZOMBIE_CLAW),
    LEVEL_UP_MOVE( 1, MOVE_SPEED_CHARGE),
    LEVEL_UP_MOVE(21, MOVE_SPITE),
    LEVEL_UP_MOVE(25, MOVE_PHYSICAL_DRAIN),
...
static const struct LevelUpMove sSoulmonLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_ZOMBIE_CLAW),
    LEVEL_UP_MOVE( 1, MOVE_GUARD_BREAK),
    LEVEL_UP_MOVE( 1, MOVE_DISABLE),
    LEVEL_UP_MOVE( 1, MOVE_ICY_WIND),
    LEVEL_UP_MOVE( 1, MOVE_BLACKOUT),
    ...
    LEVEL_UP_MOVE(25, MOVE_BLACKOUT),
    LEVEL_UP_MOVE(29, MOVE_ELECTRIC_CLOUD),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sBirdramonLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
    LEVEL_UP_MOVE( 1, MOVE_MAGIC_BIND),
    LEVEL_UP_MOVE( 1, MOVE_METEOR_WING),
    LEVEL_UP_MOVE( 1, MOVE_SMOKESCREEN),
    LEVEL_UP_MOVE(19, MOVE_MAGIC_BIND),
    LEVEL_UP_MOVE(25, MOVE_REVIVE),
    LEVEL_UP_MOVE(27, MOVE_WIND_CUTTER),
    LEVEL_UP_MOVE(34, MOVE_WING_SHOES),
    LEVEL_UP_END
};

//SPECIES_SABERDRAMON
static const struct LevelUpMove sSaberdramonLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_BLACK_SABER),
    LEVEL_UP_MOVE( 1, MOVE_PURSUIT),
    LEVEL_UP_MOVE( 1, MOVE_HAZE),
    LEVEL_UP_MOVE( 1, MOVE_WING_ATTACK),
    LEVEL_UP_MOVE(19, MOVE_MAGIC_BIND),
    LEVEL_UP_MOVE(25, MOVE_REVIVE),
    LEVEL_UP_MOVE(25, MOVE_WING_SHOES),
    LEVEL_UP_MOVE(35, MOVE_NASTY_PLOT),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sCentarumonLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_HUNTING_CANNON),
    LEVEL_UP_MOVE( 1, MOVE_CRITICAL_CHARGE),
    LEVEL_UP_MOVE( 1, MOVE_CHARGE),
    LEVEL_UP_MOVE( 1, MOVE_ELECTRIC_CLOUD),
    LEVEL_UP_MOVE(20, MOVE_ELECTRIC_CLOUD),
    LEVEL_UP_MOVE(25, MOVE_CRITICAL_CHARGE),
    LEVEL_UP_MOVE(28, MOVE_JET_GALLOP),
    LEVEL_UP_MOVE(31, MOVE_STOMP),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sClockmonLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_CHRONO_BREAKER),
...
//SPECIES_CYCLOMON
static const struct LevelUpMove sCyclomonLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
...
//SPECIES_EVILMON
static const struct LevelUpMove sEvilmonLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_PECK),
...
static const struct LevelUpMove sFlarelizarmonLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_EMBER),
...
static const struct LevelUpMove sDarklizarmonLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 1, MOVE_EMBER),
    LEVEL_UP_MOVE( 1, MOVE_HOWL),
    LEVEL_UP_MOVE( 7, MOVE_HOWL),
...
//SPECIES_GOKIMON
static const struct LevelUpMove sGokimonLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_SUPERSONIC),
    LEVEL_UP_MOVE( 8, MOVE_SUPERSONIC),
...
//SPECIES_GORIMON
static const struct LevelUpMove sGorimonLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 1, MOVE_LOW_KICK),
    LEVEL_UP_MOVE( 1, MOVE_RAGE),
...
//SPECIES_HANUMON
static const struct LevelUpMove sHanumonLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 1, MOVE_EMBER),
    LEVEL_UP_MOVE( 7, MOVE_EMBER),
...
//SPECIES_IGAMON
static const struct LevelUpMove sIgamonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_MOVE(13, MOVE_MASS_MORPH),
    LEVEL_UP_MOVE( 1, MOVE_QUICK_ATTACK),
...
static const struct LevelUpMove sKaratukinumemonLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_MUD_SLAP),
    LEVEL_UP_MOVE( 1, MOVE_MUD_SPORT),
    LEVEL_UP_MOVE( 1, MOVE_HARDEN),
    LEVEL_UP_MOVE( 1, MOVE_WATER_PULSE),
...
static const struct LevelUpMove sMechanorimonLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(20, MOVE_CONFUSION),
...
//SPECIES_MINOTAURMON
static const struct LevelUpMove sMinotaurmonLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 4, MOVE_TAIL_WHIP),
...
//SPECIES_REVOLMON
static const struct LevelUpMove sRevolmonLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_METAL_SOUND),
    LEVEL_UP_MOVE( 1, MOVE_THUNDER_SHOCK),
    LEVEL_UP_MOVE( 1, MOVE_SUPERSONIC),
...
//SPECIES_RUKAMON
static const struct LevelUpMove sRukamonLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_POWDER_SNOW),
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 1, MOVE_WATER_GUN),
    LEVEL_UP_MOVE( 1, MOVE_ENCORE),
...
//SPECIES_TAILMON
static const struct LevelUpMove sTailmonLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 1, MOVE_BITE),
    LEVEL_UP_MOVE(11, MOVE_BITE),
...
//SPECIES_VEGIMON
static const struct LevelUpMove sVegimonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_MOVE(13, MOVE_MASS_MORPH),
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
...
//SPECIES_ZASSOUMON
static const struct LevelUpMove sZassoumonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_MOVE(13, MOVE_MASS_MORPH),
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
...
//SPECIES_REDVEGIMON
static const struct LevelUpMove sRedvegimonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_MOVE(13, MOVE_MASS_MORPH),
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
...
static const struct LevelUpMove sWhamon_adultLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_MOVE( 1, MOVE_SPLASH),
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
...
//SPECIES_WIZARMON
static const struct LevelUpMove sWizarmonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_MOVE( 1, MOVE_QUICK_ATTACK),
    LEVEL_UP_MOVE( 1, MOVE_LEER),
...
//SPECIES_YUKIDARUMON
static const struct LevelUpMove sYukidarumonLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_SUPERPOWER),
    LEVEL_UP_MOVE( 1, MOVE_AQUA_JET),
    LEVEL_UP_MOVE( 1, MOVE_POWDER_SNOW),
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
...
static const struct LevelUpMove sTsuchidarumonLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_SAND_ATTACK),
    LEVEL_UP_MOVE( 7, MOVE_BITE),
    LEVEL_UP_MOVE(13, MOVE_YAWN),
...
static const struct LevelUpMove sAnomalocarimonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sAtlurkabuterimonrLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sAtlurkabuterimonbLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_END
};
...
//SPECIES_BRACHIMON
static const struct LevelUpMove sBrachimonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_END
};
...
//SPECIES_CHIMAIRAMON
static const struct LevelUpMove sChimairamonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_END
};
...
//SPECIES_DAGOMON
static const struct LevelUpMove sDagomonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sDeathmeramonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_END
};
...
//SPECIES_DELUMON
static const struct LevelUpMove sDelumonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_END
};
...
//SPECIES_GERBEMON
static const struct LevelUpMove sGerbemonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sGigadramonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_DARK_TWISTER),
    LEVEL_UP_END
};
...
//SPECIES_HANGYOMON
static const struct LevelUpMove sHangyomonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_END
};
...
//SPECIES_HOLYANGEMON
static const struct LevelUpMove sHolyangemonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_END
};
...
//SPECIES_INSEKIMON
static const struct LevelUpMove sInsekimonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_END
};
...
//SPECIES_JYAGAMON
static const struct LevelUpMove sJyagamonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_END
};
...
//SPECIES_JYUREIMON
static const struct LevelUpMove sJyureimonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_END
};
...
//SPECIES_LILIMON
static const struct LevelUpMove sLilimonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_END
};
...
//SPECIES_MAMMON
static const struct LevelUpMove sMammonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sMetalgreymonvLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_END
};
...
//SPECIES_NANOMON
static const struct LevelUpMove sNanomonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_END
};
...
//SPECIES_PANJYAMON
static const struct LevelUpMove sPanjyamonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_END
};
...
//SPECIES_PICCOLOMON
static const struct LevelUpMove sPiccolomonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_MOVE(13, MOVE_MASS_MORPH),
    LEVEL_UP_END
...
//SPECIES_PUMPMON
static const struct LevelUpMove sPumpmonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sTonosamagekomonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_END
};
...
//SPECIES_VADERMON
static const struct LevelUpMove sVadermonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_END
};
...
//SPECIES_VAMDEMON
static const struct LevelUpMove sVamdemonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sWhamon_perfectLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_END
};
...
//SPECIES_DEMON
static const struct LevelUpMove sDemonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_END
};
...
//SPECIES_DIABLOMON
static const struct LevelUpMove sDiablomonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_END
};
...
//SPECIES_GODDRAMON
static const struct LevelUpMove sGoddramonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_END
};
...
//SPECIES_GRIFFOMON
static const struct LevelUpMove sGriffomonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sHeraklekabuterimonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_MOVE(13, MOVE_MASS_MORPH),
    LEVEL_UP_END
...
//SPECIES_HOLYDRAMON
static const struct LevelUpMove sHolydramonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_END
};
...
//SPECIES_HOUOUMON
static const struct LevelUpMove sHououmonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_END
};
...
//SPECIES_MUGENDRAMON
static const struct LevelUpMove sMugendramonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_END
};
...
//SPECIES_OMEGAMON
static const struct LevelUpMove sOmegamonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_END
};
...
//SPECIES_PIEMON
static const struct LevelUpMove sPiemonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_END
};
...
//SPECIES_PINOCCHIMON
static const struct LevelUpMove sPinocchimonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_END
};
...
//SPECIES_SKULLMAMMON
static const struct LevelUpMove sSkullmammonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sVenomvamdemonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_LEER),
    LEVEL_UP_END
};
