...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_EMPOLEON] =
    {
        ...
        .baseSpAttack  = 111,
        .baseSpDefense = 101,
        .types = MON_TYPES(TYPE_WATER, TYPE_METAL),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 265,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_BIBAREL] =
    {
        ...
        .baseSpAttack  = 55,
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_NEUTRAL, TYPE_WATER),
        .catchRate = 127,
...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_LUCARIO] =
    {
        ...
        .baseSpAttack  = 115,
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_COMBAT, TYPE_METAL),
        .catchRate = 45,
...
#if P_FAMILY_ROTOM
#define ROTOM_FAMILY_TYPES { TYPE_ELECTRIC, TYPE_UNDEAD }
    ...
    [SPECIES_DIALGA] =
    {
        ...
        .baseSpAttack  = 150,
        .baseSpDefense = 100,
        .types = MON_TYPES(TYPE_METAL, TYPE_DRAGON),
        .catchRate = 3,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 340,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_HEATRAN] =
    {
        ...
        .baseSpAttack  = 130,
        .baseSpDefense = 106,
        .types = MON_TYPES(TYPE_FIRE, TYPE_METAL),
        .catchRate = 3,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 300,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
...
#define ARCEUS_SPECIES_INFO(type, typeName, iconPal)                                \
    ...
    [SPECIES_ARCEUS_NORMAL]   = ARCEUS_SPECIES_INFO(TYPE_NEUTRAL,   Normal,   1),
    ...
    [SPECIES_ARCEUS_STEEL]    = ARCEUS_SPECIES_INFO(TYPE_METAL,    Steel,    0),
    ...
    [SPECIES_ARCEUS_PSYCHIC]  = ARCEUS_SPECIES_INFO(TYPE_LIGHT,  Psychic,  1),
