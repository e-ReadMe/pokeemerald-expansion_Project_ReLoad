...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_BULBASAUR] =
    {
        ...
        .baseSpAttack  = 65,
        .baseSpDefense = 65,
        .types = MON_TYPES(TYPE_NULL, TYPE_COMBAT, TYPE_WIND),
        .catchRate = 45,
        .expYield = 64,
        .evYield_SpAttack = 1,
    ...
    [SPECIES_CHARIZARD] =
    {
        ...
        .baseSpDefense = 85,
        .types = MON_TYPES(TYPE_VACCINE, TYPE_FIRE, TYPE_PUPPET),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 267,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
...
#else
    #define CLEFAIRY_FAMILY_TYPES { TYPE_NULL, TYPE_NULL }
#endif
...
#if P_UPDATED_TYPES >= GEN_6
    #define JIGGLYPUFF_FAMILY_TYPES { TYPE_NULL, TYPE_PUPPET}
#else
    #define JIGGLYPUFF_FAMILY_TYPES { TYPE_NULL, TYPE_NULL}
#endif
