...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_BULBASAUR] =
    {
        ...
        .baseSpAttack  = 65,
        .baseSpDefense = 65,
        .types = MON_TYPES(TYPE_NORMAL, TYPE_FIGHTING, TYPE_FLYING),
        .catchRate = 45,
        .expYield = 64,
        .evYield_SpAttack = 1,
    ...
    [SPECIES_IVYSAUR] =
    {
        ...
        .baseSpAttack  = 80,
        .baseSpDefense = 80,
        .types = MON_TYPES(TYPE_POISON, TYPE_GROUND, TYPE_ROCK),
        .catchRate = 45,
    ...
    [SPECIES_VENUSAUR] =
    {
        ...
        .baseSpAttack  = 100,
        .baseSpDefense = 100,
        .types = MON_TYPES(TYPE_BUG, TYPE_GHOST, TYPE_STEEL),
        .catchRate = 45,
    ...
    [SPECIES_CHARMELEON] =
    {
        ...
        .baseSpDefense = 65,
        .types = MON_TYPES(TYPE_ELECTRIC, TYPE_PSYCHIC, TYPE_ICE),
        .catchRate = 45,
        .expYield = 142,
        .evYield_Speed = 1,
        .evYield_SpAttack = 1,
...
#define CHARIZARD_SP_ATK (P_UPDATED_STATS >= GEN_2 ? 109 : 85)
    ...
    [SPECIES_CHARIZARD] =
    {
        ...
        .baseSpDefense = 85,
        .types = MON_TYPES(TYPE_DRAGON, TYPE_DARK, TYPE_FAIRY),
        .catchRate = 45,
...
#define PIKACHU_SP_DEF (P_UPDATED_STATS >= GEN_6 || P_UPDATED_STATS == GEN_1 ? 50 : 40)
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_RUN_AWAY, ABILITY_RUN_AWAY, ABILITY_HUSTLE },
    #else
        .abilities = { ABILITY_RUN_AWAY, ABILITY_RUN_AWAY, ABILITY_HUSTLE },
    #endif
        .bodyColor = BODY_COLOR_BLUE,
