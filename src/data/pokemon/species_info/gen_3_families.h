...
#if P_FAMILY_RALTS
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_PUPPET : TYPE_LIGHT)
    ...
    [SPECIES_RALTS] =
    {
        ...
        .baseSpAttack  = 45,
        .baseSpDefense = 35,
        .types = MON_TYPES(TYPE_LIGHT, RALTS_FAMILY_TYPE2),
        .catchRate = 235,
    ...
    [SPECIES_ARON] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 40,
        .types = MON_TYPES(TYPE_METAL, TYPE_BEAST),
        .catchRate = 180,
    ...
    [SPECIES_MEDITITE] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 55,
        .types = MON_TYPES(TYPE_COMBAT, TYPE_LIGHT),
        .catchRate = 180,
    ...
    [SPECIES_LUNATONE] =
    {
        ...
        .baseSpAttack  = 95,
        .baseSpDefense = 85,
        .types = MON_TYPES(TYPE_BEAST, TYPE_LIGHT),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_7
        .expYield = 161,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_BALTOY] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_EARTH, TYPE_LIGHT),
        .catchRate = 255,
    ...
    [SPECIES_BELDUM] =
    {
        ...
        .baseSpAttack  = 35,
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_METAL, TYPE_LIGHT),
        .catchRate = 3,
    ...
    [SPECIES_LATIAS] =
    {
        ...
        .baseSpAttack  = 110,
        .baseSpDefense = 130,
        .types = MON_TYPES(TYPE_DRAGON, TYPE_LIGHT),
        .catchRate = 3,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 300,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
