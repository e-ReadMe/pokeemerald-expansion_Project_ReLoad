...
#define SILVALLY_SPECIES_INFO(type, _palette)                                       \
    ...
    [SPECIES_SILVALLY_NORMAL]   = SILVALLY_SPECIES_INFO(TYPE_NEUTRAL,   Normal),
    ...
    [SPECIES_SILVALLY_STEEL]    = SILVALLY_SPECIES_INFO(TYPE_METAL,    Steel),
    ...
    [SPECIES_SILVALLY_PSYCHIC]  = SILVALLY_SPECIES_INFO(TYPE_LIGHT,  Psychic),
...
#define MINIOR_CORE_SPECIES_INFO(Form, color, iconPal, heldItem)\
    ...
    [SPECIES_DRAMPA] =
    {
        ...
        .baseSpAttack  = 135,
        .baseSpDefense = 91,
        .types = MON_TYPES(TYPE_NEUTRAL, TYPE_DRAGON),
        .catchRate = 70,
        .expYield = 170,
        .evYield_SpAttack = 2,
    ...
    [SPECIES_SOLGALEO] =
    {
        ...
        .baseSpAttack  = 113,
        .baseSpDefense = 89,
        .types = MON_TYPES(TYPE_LIGHT, TYPE_METAL),
        .catchRate = 3,
    ...
    [SPECIES_LUNALA] =
    {
        ...
        .baseSpAttack  = 137,
        .baseSpDefense = 107,
        .types = MON_TYPES(TYPE_LIGHT, TYPE_UNDEAD),
        .catchRate = 3,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 340 : 306,
        .evYield_SpAttack = 3,
        .genderRatio = MON_GENDERLESS,
    ...
    [SPECIES_MAGEARNA] =
    {
        ...
        .baseSpAttack  = 130,
        .baseSpDefense = 115,
        .types = MON_TYPES(TYPE_METAL, TYPE_PUPPET),
        .catchRate = 3,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 300 : 270,
        .evYield_SpAttack = 3,
        .genderRatio = MON_GENDERLESS,
    ...
    [SPECIES_STAKATAKA] =
    {
        ...
        .baseSpAttack  = 53,
        .baseSpDefense = 101,
        .types = MON_TYPES(TYPE_BEAST, TYPE_METAL),
        .catchRate = 30,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 285 : 257,
        .evYield_Defense = 3,
        .genderRatio = MON_GENDERLESS,
