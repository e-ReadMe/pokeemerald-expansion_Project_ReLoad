...
static const struct FormChange sOgerponFormChangeTable[] = {
...
#if P_TERA_FORMS
    {FORM_CHANGE_BATTLE_TERASTALLIZATION, SPECIES_OGERPON_TEAL_TERA,        TYPE_PLANT},
    ...
    {FORM_CHANGE_BATTLE_TERASTALLIZATION, SPECIES_OGERPON_CORNERSTONE_TERA, TYPE_BEAST},
#endif
    {FORM_CHANGE_TERMINATOR},
};
