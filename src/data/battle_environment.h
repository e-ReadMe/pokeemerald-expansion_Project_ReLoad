...
#define BUILDING_CAMOUFLAGE_TYPE     TYPE_NEUTRAL
...
#define PLAIN_CAMOUFLAGE_TYPE     (B_CAMOUFLAGE_TYPES == GEN_4 || B_CAMOUFLAGE_TYPES == GEN_5) ? TYPE_EARTH : TYPE_NEUTRAL
