...
SINGLE_BATTLE_TEST("Anticipation doesn't consider Scrappy into their effectiveness (Gen5+)")
{
    GIVEN {
        ASSUME(GetMoveType(MOVE_CLOSE_COMBAT) == TYPE_COMBAT);
        ASSUME(GetSpeciesType(SPECIES_DOUBLADE, 0) == TYPE_METAL);
        ASSUME(GetSpeciesType(SPECIES_DOUBLADE, 1) == TYPE_UNDEAD);
...
{
    GIVEN {
        ASSUME(GetMoveType(MOVE_SYNCHRONOISE) == TYPE_LIGHT);
        ASSUME(GetSpeciesType(SPECIES_NIDORINO, 0) == TYPE_FILTH);
        ASSUME(GetSpeciesType(SPECIES_NIDORINO, 1) == TYPE_FILTH);
        ASSUME(GetSpeciesType(SPECIES_EEVEE, 0) != TYPE_FILTH);
        ASSUME(GetSpeciesType(SPECIES_EEVEE, 1) != TYPE_FILTH);
...
SINGLE_BATTLE_TEST("Anticipation considers Flying Press as an ordinary Fighting-type move")
{
    GIVEN {
        ...
        ASSUME(GetSpeciesType(SPECIES_TANGELA, 1) == TYPE_PLANT);
...
SINGLE_BATTLE_TEST("Anticipation considers Aura Wheel as an ordinary Electric-type move")
{
    GIVEN {
        ...
        ASSUME(GetSpeciesType(SPECIES_PONYTA_GALAR, 0) == TYPE_LIGHT);
        ASSUME(GetSpeciesType(SPECIES_PONYTA_GALAR, 1) == TYPE_LIGHT);
...
SINGLE_BATTLE_TEST("Anticipation does not consider Strong Winds on type matchups")
{
    GIVEN {
        ...
        ASSUME(GetSpeciesType(SPECIES_RAYQUAZA_MEGA, 1) == TYPE_WIND);
