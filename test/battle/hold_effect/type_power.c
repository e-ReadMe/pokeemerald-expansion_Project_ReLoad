...
{
    { TYPE_NEUTRAL,   MOVE_SCRATCH,         ITEM_SILK_SCARF },
    { TYPE_COMBAT, MOVE_KARATE_CHOP,     ITEM_BLACK_BELT },
    { TYPE_WIND,   MOVE_WING_ATTACK,     ITEM_SHARP_BEAK },
    { TYPE_FILTH,   MOVE_POISON_STING,    ITEM_POISON_BARB },
    { TYPE_EARTH,   MOVE_MUD_SHOT,        ITEM_SOFT_SAND },
    { TYPE_BEAST,     MOVE_ROCK_THROW,      ITEM_HARD_STONE },
    { TYPE_INSECT,      MOVE_BUG_BITE,        ITEM_SILVER_POWDER },
    { TYPE_UNDEAD,    MOVE_SHADOW_PUNCH,    ITEM_SPELL_TAG },
    { TYPE_METAL,    MOVE_METAL_CLAW,      ITEM_METAL_COAT },
    { TYPE_FIRE,     MOVE_EMBER,           ITEM_CHARCOAL },
    { TYPE_WATER,    MOVE_WATER_GUN,       ITEM_MYSTIC_WATER },
    { TYPE_PLANT,    MOVE_VINE_WHIP,       ITEM_MIRACLE_SEED },
    { TYPE_ELECTRIC, MOVE_THUNDER_SHOCK,   ITEM_MAGNET },
    { TYPE_LIGHT,  MOVE_CONFUSION,       ITEM_TWISTED_SPOON },
    ...
    { TYPE_PUPPET,    MOVE_DISARMING_VOICE, ITEM_FAIRY_FEATHER },
};
